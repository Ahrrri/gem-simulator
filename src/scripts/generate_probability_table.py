...
def calculate_probabilities(gem: GemState, memo: Dict[str, Dict], combo_memo: Dict[str, Dict]) -> Dict[str, Dict]:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"예: SELECT * FROM goal_probabilities WHERE prob_ancient > 0.8 ORDER BY prob_ancient DESC;")
